model = dict(
    type='Recognizer3D',
    backbone=dict(
        type='ResNet3dSlowOnly_3d_gcn_tcn',
        in_channels=1,
        base_channels=32,
        num_stages=3,
        out_indices=(2, ),
...
train_pipeline = [
    ...
    dict(type='FormatShape', input_format='NCTHW_1DHeatmapBishal'),
...
lr_config = dict(policy='CosineRestart', by_epoch=False, min_lr=0, periods=[42000, 84000, 126000, 168000, 208151], restart_weights=[0.05, 0.01, 0.005, 0.001, 0.0005])
total_epochs = 50
checkpoint_config = dict(interval=1)
evaluation = dict(interval=1, metrics=['top_k_accuracy', 'mean_class_accuracy'], topk=(1, 5))
log_config = dict(interval=20, hooks=[dict(type='TextLoggerHook')])
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_ait/joint_3d_gcn_tcn_2_2_2_cosineRestart'
