...
def confusion_matrix(y_pred, y_real, normalize=None):
    ...
    report = classification_report(y_real, y_pred, digits=3)
...
def display_confusion_matrix(confusion):
    ...
    LABELS = ["bend", "sit", "sit_clap", "sit_phonecall", "sit_point", "sit_checktime", "sit_wave", "stand", "stand_clap", "stand_phonecall",
                "stand_point", "stand_checktime", "stand_wave", "walk", "fall", "unstable"]
...
def mean_class_accuracy(scores, labels):
    ...
    display_confusion_matrix(cf_mat)
